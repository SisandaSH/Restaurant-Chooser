...
function App() {
  ...
  const restaurantRecommendations = {
    ...
    fish: {
      soda: { name: 'Fish Shack', description: 'Fresh seafood with ice-cold sodas.' },
      beer: { name: 'Catch & Brew', description: 'Daily caught fish with local craft beers.' },
      wine: { name: 'Seafood & Vino', description: 'Elegant seafood dining with curated wines.' },
      cocktail: { name: 'Ocean Mixology', description: 'Seafood specialties with tropical cocktails.' },
      juice: { name: 'Fresh Catch', description: 'Grilled fish with freshly squeezed juices.' },
      coffee: { name: 'Harbor Cafe', description: 'Seafood brunch with specialty coffees.' },
      tea: { name: 'Sea & Steep', description: 'Asian-inspired seafood with premium teas.' },
    },
    chicken: {
      soda: { name: 'Chicken Joint', description: 'Crispy fried chicken with fountain sodas.' },
      beer: { name: 'Wings & Brew', description: 'Spicy wings and cold beers.' },
      wine: { name: 'Roast & Pour', description: 'Rotisserie chicken with wine pairings.' },
      cocktail: { name: 'Chicken & Spirits', description: 'Gourmet chicken dishes with craft cocktails.' },
      juice: { name: 'Healthy Bird', description: 'Grilled chicken with fresh fruit juices.' },
      coffee: { name: 'Early Bird', description: 'Chicken breakfast options with premium coffee.' },
      tea: { name: 'Poultry & Leaf', description: 'Asian-style chicken with herbal teas.' },
    },
    dessert: {
      soda: { name: 'Sweet Fizz', description: 'Decadent desserts with classic sodas.' },
      beer: { name: 'Sweet & Hoppy', description: 'Dessert and beer pairings.' },
      wine: { name: 'Sweet Pour', description: 'Dessert and wine pairings.' },
      cocktail: { name: 'Sugar & Spirits', description: 'Desserts with dessert cocktails.' },
      juice: { name: 'Fruit & Sweet', description: 'Fruit-based desserts with fresh juices.' },
      coffee: { name: 'Cafe Dulce', description: 'Coffee and dessert specialties.' },
      tea: { name: 'Tea & Sweets', description: 'Tea shop with delicious pastries.' },
    },
    burger: {
      soda: { name: 'Burger Joint', description: 'Classic burgers with fountain sodas.' },
      beer: { name: 'Burgers & Brews', description: 'Gourmet burgers with craft beer selection.' },
      wine: { name: 'Upscale Burger Bar', description: 'Gourmet burgers with wine pairings.' },
      cocktail: { name: 'Burger & Shake', description: 'Creative burgers with boozy shakes.' },
      juice: { name: 'Healthy Burger', description: 'Lean burgers with fresh-squeezed juices.' },
      coffee: { name: 'Morning Burger', description: 'Breakfast burgers with premium coffee.' },
      tea: { name: 'Burger & Steep', description: 'Asian-fusion burgers with hot teas.' },
    },
  };
        ...
        {step === 3 && recommendation && (
          <div className="result-step">
            ...
            <div className="recommendation-card">
              ...
              <img src={restaurantRecommendations.image} alt={restaurantRecommendations.alt} height="200px" width="200px" />
